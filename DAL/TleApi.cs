   ...
   public class TleApi
    {
        ...
        public TlePropagate GetTlePropagate(int id,string date="")
        {
            ...
            if (responseStr != null)
            {
                ...
                string rf=(string) (dict["vactor"]as Newtonsoft.Json.Linq.JObject)["reference_frame"];
                Object3d p0 = new Object3d();
                Object3d dir = new Object3d();
                var indexer1 = (dict["vactor"] as Newtonsoft.Json.Linq.JObject)["position"];
                p0.x= (double)indexer1["x"];
                p0.y= (double)indexer1["y"];
                p0.z= (double)indexer1["z"];
                p0.r = (double)indexer1["r"];
                p0.unitName=(string)indexer1["unit"];
                var indexer2 = (dict["vactor"] as Newtonsoft.Json.Linq.JObject)["velocity"];
                ...
                var indexer3 = dict["geodetic"] as Newtonsoft.Json.Linq.JArray;
                result.Geodetic = ((double)indexer3["latitude"], (double)indexer3["longitude"], (double)indexer3["altitude"]);
                var indexer4= dict["tle"] as Newtonsoft.Json.Linq.JArray;
